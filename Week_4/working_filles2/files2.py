...
# # # # # # f = open(workspace / "created_once.txt", "a", encoding="utf-8")
...
# # # # # # # f = open(file_path, "r", encoding="utf-8")
# # # # # # # n = 10     # first number of characters
# # # # # # # content = f.read(n)
# # # # # # # f.close()
# # # # # # # print(content)      # Shopping L

# # # # # # # f = open(file_path, "r", encoding="utf-8")
# # # # # # # print("First line:", f.readline().rstrip())
# # # # # # # print("Second line:", f.readline().rstrip())
# # # # # # # print("Third line:", f.readline().rstrip())
# # # # # # # f.close
...
# # # # # # # # Lines list: ['Shopping List:', ' 1. Rice', ' 2. Beans', ' 3. Garri', ' 4. Noodles', ' 5. Groundnut oil', ' 6. Maggi']
...
# # # # # # # with open(workspace / "created_once.txt", "a", encoding="utf-8") as f:
# # # # # # #     f.write(" - Yes, I did it.\n")
...
# # # # # """
# # # # # ound the file: notes.txt
# # # # # File size: 51 bytes
# # # # # Content preview: This is the first line in notes.txt
# # # # # I still exist....
# # # # # """
...
# # # """
# # # Reading CSV file:
# # # Headers: Name | Age | Course | Grade
# # # ----------------------------------------
# # # Precious (20 years) - Python: A-
# # # Favour (22 years) - JavaScript: B+
# # # Ore (28 years) - Python: A
# # # Susan (23 years) - Data Science: A
# # # """
...
# File positioning demo:
# First 20 characters: 'Once upon a time, th'
# Current position in file: 20
# After seeking to beginning: position 0
# Reading from position 50: 'urious and inquisitive,'
# First line: 'Once upon a time, there was a lady  who was very curious and inquisitive,'    
#     """
