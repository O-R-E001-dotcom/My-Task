...
# Using the function in the first.py file

print("=== Math Functions ===")  # === Math Functions ===
print("5 + 3 =", first.add(5, 3))   # 5 + 3 = 8
print("10 - 4 =", first.subtract(10, 4))    # 10 - 4 =
print("6 * 7 =", first.multiply(6, 7))      # 6 * 7 = 42
print("20 / 5 =", first.divide(20, 5))      # 20 / 5 = 4.0

# Lets use the functions in the second.py file
print("\n=== String ===")       # === String ===
print(second.greet("Joy"))      # Hello, Joy! I am creating my own module
print("Reverse of 'Python' =", second.reverse_string("Python")) # Reverse of 'Python' = nohtyP
print("Character count in sentence =", second.count_character("Python modules are powerful"))   # Character count in sentence = 27
