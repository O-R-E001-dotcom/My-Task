...
currently = Other_schorlarships == "yes" 
...
# enrollment = input("enter your course: ").title()
# other_schorlarships = input(" enter if you have other schorlarships: ")
# academic_quali = input("enter if you have 5 credits or more: ")
